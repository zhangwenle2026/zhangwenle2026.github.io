...
prev = {
    'region': {
        'total': data['region']['total'],  # total doesn't change
        'assigned': 0,
        'operating': 113,
        'score': 538,
    },
    'directions': {
        'not sign': {'target': 553, 'operating': 42, 'score': 252},
        'not online': {'target': 46, 'operating': 13, 'score': 52},
        'not operating': {'target': 219, 'operating': 58, 'score': 174},
    },
    'cities': {
        'Southern': {
            'target': 413, 'assigned': 0, 'operating': 47, 'score': 216,
            'directions': {
                'not sign': {'target': 278, 'operating': 16, 'score': 96, 'pct': 5.8},
                'not online': {'target': 18, 'operating': 3, 'score': 12, 'pct': 16.7},
                'not operating': {'target': 117, 'operating': 28, 'score': 84, 'pct': 23.9},
            }
        },
        'Western': {
            'target': 331, 'assigned': 0, 'operating': 54, 'score': 265,
            'directions': {
                'not sign': {'target': 220, 'operating': 22, 'score': 132, 'pct': 10.0},
                'not online': {'target': 24, 'operating': 7, 'score': 28, 'pct': 29.2},
                'not operating': {'target': 87, 'operating': 25, 'score': 75, 'pct': 28.7},
            }
        },
        'Santos': {
            'target': 74, 'assigned': 0, 'operating': 12, 'score': 57,
            'directions': {
                'not sign': {'target': 55, 'operating': 4, 'score': 24, 'pct': 7.3},
                'not online': {'target': 4, 'operating': 3, 'score': 12, 'pct': 75.0},
                'not operating': {'target': 15, 'operating': 5, 'score': 15, 'pct': 33.3},
            }
        },
    }
}

# Previous assigned counts (calculated from 0817 Excel)
prev['region']['assigned'] = 294
prev['cities']['Southern']['assigned'] = 145
prev['cities']['Western']['assigned'] = 129
prev['cities']['Santos']['assigned'] = 20
...
.stats-bar {{ margin-top: 16px; padding: 12px; background: #f8f9fa; border-radius: 8px; font-size: 12px; color: #555; display: flex; flex-wrap: wrap; gap: 12px; }}
...
<div class="date">Data as of \u6570\u636e\u622a\u81f3: 2026-08-19 (BRT) | Metropolitan Region | Operating Period: 0813-0819</div>
</div>
...
<div class="dod-card">
<h3>\U0001f4c8 Day-over-Day Changes \u65e5\u73af\u6bd4\u53d8\u5316 (vs 08-17)</h3>
<div class="dod-grid">
