#!/usr/bin/env python3
"""Fast BI data fetch v2 - save incrementally"""
...
async def query_and_save(ws, sid, results, name, cid):
    ...
    results[name] = data
    save_results(results)  # Save after each chart
...
async def main():
    ...
    async with websockets.connect(ws_url) as ws:
        ...
        await cdp_send(ws, session_id, "Page.navigate", {"url": "https://bi.keetapp.com/v2/dashboard/dashboard-controller?dashboardId=300001446"})
