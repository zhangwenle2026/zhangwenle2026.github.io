...
wb = openpyxl.load_workbook('redtop2000merchantsstatus-0820.xlsx', data_only=True)
ws = wb['Sheet1']
...
for r in range(2, ws.max_row+1):
    ...
    if region == 'Metropolitan Region' and city in metro_cities:
        row = {
            ...
            'sign': ws.cell(r, cols['sign-0820']).value,
            'operating': ws.cell(r, cols['0814-0820 operating']).value,
        }
        all_rows.append(row)
...
# Previous data (0819)
with open('order_penetration_data_0819_final_v2.json', 'r') as f:
    prev_data = json.load(f)

# Build output JSON
output = {
    'data_date': '0820',
    'operating_period': '0814-0820',
    'previous': {
        'date': '0819',
...
with open('order_penetration_data_0820_final.json', 'w') as f:
    json.dump(output, f, indent=2, default=str)
print("\nSaved to order_penetration_data_0820_final.json")
