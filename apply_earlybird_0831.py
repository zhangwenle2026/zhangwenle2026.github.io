...
json.dump(D, open('order_penetration_data_0831_raw.json', 'w'), indent=2, default=str, ensure_ascii=False)
print('saved order_penetration_data_0831_raw.json (early bird applied)')
