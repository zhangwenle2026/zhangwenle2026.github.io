...
# ===== CONFIG =====
NEW_FILE = 'redtop2000merchantsstatus-0825.xlsx'
NEW_DATE = '0825'
NEW_PERIOD = '0819-0825'
PREV_FILE = 'order_penetration_data_0823_final.json'
OUT_FILE = 'order_penetration_data_0825_final.json'
...
output = {
    ...
    'previous': {'date': prev['data_date'], 'total_operating': p['total_operating'], 'total_score': p['total_score'],
                 'bd_level_score': p['bd_level_score'], 'ns_op': p['ns_op'], 'no_op': p['no_op'], 'nop_op': p['nop_op'],
