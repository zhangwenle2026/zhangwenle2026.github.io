...
xml = open('rank_wiki_0831_before.xml', encoding='utf-8').read()
...
new_title = 'SP Metro Incentive Race Rankings — Aug 31 / 圣保罗都市圈激励赛排名 — 8月31日 / Classificação da Corrida de Incentivo — 31 de Agosto'
new_date_p = '<p nodeId="d2e4a5fe-31c4-4195-b3d1-b72c64d649b4"><strong>Data as of / 数据截至 / Dados截至:</strong> August 31, 2026 (BRT)</p>'
...
open('rank_wiki_0831_new.xml', 'w', encoding='utf-8').write(out)
...
assert 'August 31, 2026' in out and 'Aug 31' in out
