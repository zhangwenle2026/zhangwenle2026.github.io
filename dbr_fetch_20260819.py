#!/usr/bin/env python3
"""DBR data fetch for 2026-08-19 - using current BI tab"""
import asyncio
import json
import websockets
...
async def cdp_fetch():
    async with websockets.connect(PAGE_WS) as ws:
        ...
        # Query charts - chart IDs from components
        charts = [
            ...
            ("Order Performance", "dashboard-chart-container-7p18g-b0ef9"),
        ]
        ...
        if has_data >= 2:
            ...
            out = "/tmp/files/dbr_data_20260819.json"
            with open(out, "w") as f:
                json.dump({"date": "2026-08-19", "data_source":"dom", "results":results}, f, ensure_ascii=False, indent=2)
        ...
        if resp:
            ...
            if data:
                import os, base64
                os.makedirs("/tmp/files", exist_ok=True)
                out = "/tmp/files/dbr_screenshot.png"
