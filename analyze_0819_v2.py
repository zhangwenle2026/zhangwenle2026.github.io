...
# ===== ALSO COMPUTE REGIONAL/CITY OVERVIEW (same as before, data doesn't change) =====
...
# Previous data (0817)
with open('order_penetration_data_0817_final.json', 'r') as f:
...
with open('order_penetration_data_0819_final_v2.json', 'w') as f:
    json.dump(output, f, indent=2, default=str)
print("\nSaved to order_penetration_data_0819_final_v2.json")
