...
async def diagnose():
    async with async_playwright() as p:
        ...
        # Use a new page in the existing context to leverage cookies
        context = contexts[0]
        ...
        try:
            ...
            if "login" in page.url.lower() or "auth" in page.url.lower() or "sso" in page.url.lower():
                ...
                # Try to see if there's a QR code or login form
            ...
            if ready:
                ...
                print("DashboardController not available - checking page state...")
                body = await page.content()
                print(f"Page body snippet: {body[:500]}")
